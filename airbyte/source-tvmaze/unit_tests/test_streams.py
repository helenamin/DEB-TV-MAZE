...
import pytest
from source_tvmaze.source import TvmazeStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(TvmazeStream, "path", "v0/example_endpoint")
    mocker.patch.object(TvmazeStream, "primary_key", "test_primary_key")
    mocker.patch.object(TvmazeStream, "__abstractmethods__", set())
